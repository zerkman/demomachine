...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports pclk] [get_bd_pins clk_wiz_0/clk_out1]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_protocol_convert_0/aresetn] [get_bd_pins configurator_0/S_AXI_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins configurator_0/in_reg0] [get_bd_pins configurator_0/in_reg1] [get_bd_pins xlconstant_0/dout]
